...
{
	const uint8_t hwaddr1[6] = { 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6 };
	const uint8_t hwaddr2[6] = { 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6 };
	const uint8_t hwaddr3[6] = { 0xf1, 0xf2, 0xf3, 0xf5, 0xf5, 0xf6 };

	ck_assert_int_eq(hwaddr_eq(hwaddr1, hwaddr2), true);
	ck_assert_int_eq(hwaddr_eq(hwaddr1, hwaddr3), false);
}
END_TEST
...
START_TEST(test_hwaddr_cp)
{
	...
	hwaddr_init(hwaddr2, 0);
	hwaddr_copy(hwaddr2, hwaddr1);

	for (i = 0; i < 6; i++)
		ck_assert_int_eq(hwaddr1[i], hwaddr2[i]);
}
END_TEST
